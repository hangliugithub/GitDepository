...
import com.cpinfo.hl7.dao.PatientDao;
...
public class PatientService{
	 ...
	 * @return
	 */
	public List<Patient> findHisPatient(String id){
...
//		p = MyParser.parseToObject(str, strType, Patient.class);
	 ...
	 * @return
	 */
	private Patient setPatientInfo(Map<String,String> patientMap){
