...
import com.cpinfo.fhirserver.dao.ConditionDao;
...
//		Condition condition = MyParser.parseToObject(str, strType, Condition.class);
	 ...
	 */
	public Condition readCondition(String id) throws ParseException{
	 ...
	 * @throws ParseException 
	 */
	public List<Condition> findHisCondition(String id) throws ParseException{
...
//		}
	 ...
	 * @throws ParseException 
	 */
	public List<Condition> findByPatientId(String patientId) throws ParseException{
	 ...
	 * @throws ParseException 
	 */
	public List<Condition> findByName(String conditionName) throws ParseException{
	...
	private Condition setConditionInfo(Map<String,String> map) throws ParseException{
		...
		theCodeDt.addCoding(new CodingDt()
				...
				.setCode("diagnosis").setDisplay("诊断"));
